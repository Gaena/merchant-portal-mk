...
- **Состояние на 14.09.2026:** выписка собрана по SQL провайдера и проверена на выгрузке тестового
  стенда — 114 заказов во всех статусах провайдера, включая возвраты и реверсалы. Экран вкладки
  «E-commerce» к API `ecom` ещё не подключён. Справочник терминалов провайдера собран по его SQL;
  выбор терминала из справочника при заведении поддержан в API, форма на экране ещё не сделана.
