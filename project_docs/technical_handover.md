...
- **Состояние на 14.09.2026:** выписка собрана по SQL провайдера и проверена на выгрузке тестового
  ...
  «E-commerce» к API `ecom` ещё не подключён. Выбор терминала из справочника провайдера при заведении
  терминала поддержан в API, форма на экране появится после согласования справочника.
