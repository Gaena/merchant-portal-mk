---
Рабочий процесс (Workflow) и контекст проекта MP (Multi-Project: auth, directory, pbl) для AI-агента. Покрывает архитектуру, текущий статус, структуру БД, RBAC и инструкции по сборке/тестированию.
---
